...
var AccountPersonalInfoComponent = /** @class */ (function () {
    function AccountPersonalInfoComponent(dataService, formBuilder, router, nav) {
    ...
    AccountPersonalInfoComponent = __decorate([
        ...
        __metadata("design:paramtypes", [DataService, FormBuilder, Router, NavComponent])
    ], AccountPersonalInfoComponent);
    return AccountPersonalInfoComponent;
}());
export { AccountPersonalInfoComponent };
//# sourceMappingURL=accountPersonalInfo.component.js.map